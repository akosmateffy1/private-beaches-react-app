        ...
        <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4'>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li className='py-1'>Documenntation</li>
            ...
            <div className='col-span-2 py-8 md:pt-2'>
                <p className='col-span-2 py-8 md:pt-2'>Subscibe to our newsletters</p>
                <p className='py-4'>The Latest deels, arcticles and resources sent to your inbox weekly</p>
                <form className='flex flex-col sm:flex-row'>
                    ...
                    />
                    <button className='p-2 rounded-md'>Subscribe</button>
                </form>
            </div>
